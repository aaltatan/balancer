...
from sqlalchemy import TIMESTAMP, UUID, Boolean, ColumnElement, ForeignKey, String, func
...
class UserDB(Base):
    ...
    tenant: Mapped[Optional["TenantDB"]] = relationship("TenantDB", back_populates="users")
