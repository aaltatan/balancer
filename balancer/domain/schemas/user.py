...
from balancer.constants import USERNAME_REGEX
from balancer.domain.models.permission import Permission
from balancer.domain.models.user import Role
...
FirstnameFld = Annotated[
    ...
    BeforeValidator(lambda value: value.strip().title()),
]
